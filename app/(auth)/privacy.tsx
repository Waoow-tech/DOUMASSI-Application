// Écran Politique de confidentialité — E-PRIVACY.
// Calque la structure visuelle de terms.tsx (E-CGV).
// Affiche le contenu FR puis EN séparé par un trait.
...
import type { LegalSection } from '@/features/legal/content/cgv';
import {
  PRIVACY_CURRENT_VERSION,
  PRIVACY_EN_TITLE,
  PRIVACY_EN_UPDATED_AT,
  PRIVACY_FR_TITLE,
  PRIVACY_FR_UPDATED_AT,
  privacyEnSections,
  privacyFrSections,
      ...
      <YStack flex={1} backgroundColor="$background">
        ...
        >
          <YStack width="100%" maxWidth={720} alignSelf="center" gap="$6">
            ...
            <SectionList sections={privacyFrSections} />
            ...
            <SectionList sections={privacyEnSections} />
          </YStack>
        </ScrollView>
      </YStack>
    </SafeAreaView>
